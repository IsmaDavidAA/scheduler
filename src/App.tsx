...
function App() {
  ...
  const tableState = (table: ScheduleTable) => {
    ...
    if (attending) return { label: `ocupada ${attending}/${table.capacity}`, className: 'table occupied' }
